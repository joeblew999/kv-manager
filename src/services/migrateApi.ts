 ...
 */
export async function migrateKeys(request: MigrateRequest): Promise<MigrateResponse> {
 ...
 */
export async function migrateNamespace(request: MigrateNamespaceRequest): Promise<MigrateResponse> {
